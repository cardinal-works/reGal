...
abstract contract ERC721Token is ERC721, ERC721BasicToken {
  ...
  */
  function tokenOfOwnerByIndex(address _owner, uint256 _index) virtual override public view returns (uint256) {
  ...
  */
  function tokenByIndex(uint256 _index) virtual override public view returns (uint256) {
